    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white rounded-lg border border-border p-8 shadow-sm">
          ...
          <p className="text-neutral-dark text-center mb-8">Sign in to your Uflix account</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-dark hover:text-foreground"
                >
                  {showPassword ? (
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                ...
                <span className="ml-2 text-sm text-neutral-dark">Remember me</span>
              </label>
              <Link href="/forgot-password" className="text-sm text-accent hover:text-secondary">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-md hover:bg-neutral-light transition-colors">
          ...
          <p className="mt-8 text-center text-sm text-neutral-dark">
            ...
            <Link href="/signup" className="text-accent hover:text-secondary font-semibold">
              Sign up
            </Link>
          </p>
        </div>
